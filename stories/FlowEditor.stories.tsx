...
Videos.args = {
    defaultState: FlowEditorState.empty.set("content", FlowContent.fromJsonValue([
        ...
        { break: "para" },
        "On the next line there should be a video with placeholder and poster",
        { break: "line" },
        // eslint-disable-next-line max-len
        ...
        { break: "para" },
        "On the next line there should be a video with placeholder and broken poster",
        { break: "line" },
        // eslint-disable-next-line max-len
        ...
        { break: "para" },
        "On the next line there should be a video with empty url and without placeholder",
        { break: "line" },
