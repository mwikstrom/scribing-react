...
Rich.args = {
    defaultState: FlowEditorState.empty.set("content", FlowContent.fromJsonValue([
        ...
        { break: "para" },
        "And maybe some ", 
        { start_markup: "stuff", attr: { id: "123" } }, 
        "markup ",
        { start_markup: "Nested" },
        "that can be ",
        { empty_markup: "empty", attr: { foo: "bar" } },
        " and nested",
        { end_markup: "Nested" },
        { end_markup: "stuff" },
        "? ",
...
ScaledDownImage.args = {
    defaultState: FlowEditorState.empty.set("content", FlowContent.fromJsonValue([
        // eslint-disable-next-line max-len
        { image: { url: "https://unsplash.com/photos/Kp9z6zcUfGw/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjM1OTQ0MzY2&w=1920", width: 1920, height: 1441 }, scale: 0.1 },
        "Some text",
        { break: "para" },
    ])),
};
...
Videos.args = {
    defaultState: FlowEditorState.empty.set("content", FlowContent.fromJsonValue([
        ...
        { break: "para" },
        // eslint-disable-next-line max-len
        "On the next line there should be a video with working URL and placeholder (no poster). So the placeholder shall not be shown once the video is loaded",
        { break: "line" },
        // eslint-disable-next-line max-len
        { video: { url: "https://videos.pexels.com/video-files/20444835/20444835-hd_1280_720_30fps.mp4", placeholder: "", width: 1280, height: 720 } },
        { break: "para" },
        // eslint-disable-next-line max-len
        "On the next line there should be a video with working URL and poster (no placeholder). So the poster shall remain visible even after the video is loaded",
        { break: "line" },
        // eslint-disable-next-line max-len
        { video: { url: "https://videos.pexels.com/video-files/20444835/20444835-hd_1280_720_30fps.mp4", poster: "https://unsplash.com/photos/Kp9z6zcUfGw/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjM1OTQ0MzY2&w=1920", width: 1280, height: 720 } },
        { break: "para" },
        "On the next line there should be a video with poster only (no url, no placeholder)",
        { break: "line" },
        // eslint-disable-next-line max-len
        ...
        { break: "para" },
        "On the next line there should be a video with placeholder only (no url, no poster)",
        { break: "line" },
        // eslint-disable-next-line max-len
        ...
        { break: "para" },
        "On the next line there should be a video with placeholder and poster (but no url)",
        { break: "line" },
        // eslint-disable-next-line max-len
        { video: { url: "", poster: "https://unsplash.com/photos/Kp9z6zcUfGw/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjM1OTQ0MzY2&w=1920", placeholder: "", width: 300, height: 225 } },
        { break: "para" },
        "On the next line there should be a video with placeholder and broken poster (and no url)",
        { break: "line" },
        // eslint-disable-next-line max-len
        { video: { url: "", poster: "broken", placeholder: "", width: 300, height: 225 } },
        { break: "para" },
        "On the next line there should be a video with empty url and without placeholder or poster",
        { break: "line" },
        { video: { url: "", width: 300, height: 225 } },
        { break: "para" },
        "On the next line there should be a broken video (and no placeholder or poster)",
        { break: "line" },
...
export const TableWithHeading = Template.bind({});
TableWithHeading.args = {
    defaultState: FlowEditorState.empty.set("content", FlowContent.fromJsonValue([
        "Before",
        { break: "para" },
        {
